 ...
 *
 * ```typescript
 * import { registerTelegramTrigger } from "../triggers/telegramTriggers"./from "../triggers/telegramTriggers;
 * import { telegramBotWorkflow } from "./workflows/telegramBotWorkflow"./from "./workflows/telegramBotWorkflow;
...
import { registerApiRoute } from "../mastra/inngest"./from "../mastra/inngest;

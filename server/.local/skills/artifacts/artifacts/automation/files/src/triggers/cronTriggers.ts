...
import { registerCronWorkflow } from "../mastra/inngest"./from "../mastra/inngest;
 ...
 *
 * ```typescript
 * import { physicsJokeWorkflow } from "./workflows/physicsJokeWorkflow"./from "./workflows/physicsJokeWorkflow;

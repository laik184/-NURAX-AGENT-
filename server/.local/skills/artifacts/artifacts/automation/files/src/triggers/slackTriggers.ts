 ...
 *
 * ```typescript
 * import { registerSlackTrigger } from "../triggers/slackTriggers"./from "../triggers/slackTriggers;
 * import { slackBotWorkflow } from "./workflows/slackBotWorkflow"./from "./workflows/slackBotWorkflow;

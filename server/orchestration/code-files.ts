 ...
 * ({ path: string, content: string }). Handles:
 *   - direct CodeFile[]
 *   - nested in dispatch results: { results: [{ data: { files: CodeFile[] } }] }
 *   - { files: CodeFile[] } anywhere in the tree
 *   - arbitrary nesting in arrays/objects
 */

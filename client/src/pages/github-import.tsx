    ...
    <div className="flex-1 flex flex-col overflow-auto text-white" style={{ background: "hsl(222,30%,7%)" }}>
      {importing && (
        <ImportLoadingOverlay
          serviceName="GitHub"
          serviceColor="#6e7681"
          serviceIcon={<SiGithub className="w-9 h-9 text-white" />}
          steps={[
          ...
          <div className="flex items-start justify-between mb-7">
            <div>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-9 h-9 rounded-xl bg-[#24292e] flex items-center justify-center">
                  <SiGithub className="w-5 h-5 text-white" />
                </div>
                <h1 className="text-2xl font-semibold text-white" data-testid="heading-github-import">
                  Import from GitHub
                </h1>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Paste a repository URL or pick one from your connected account.
              </p>
            </div>
            <a
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Or select a repository from your connected account below.
              </p>
            </div>

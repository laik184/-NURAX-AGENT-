        ...
        {!gridMode ? (
          <>
            ...
            <main className={`flex-1 overflow-hidden bg-black relative flex flex-col ${devToolsOpen ? "" : ""}`}>
              ...
              {/* ── Bottom-center floating overlay (disabled) ── */}
              {false && (
                <div style={{
                  position: "absolute",
              ...
              <DevToolsPanel
                ...
                devToolsMinimized={devToolsMinimized}
                ...
                setDevToolsMinimized={setDevToolsMinimized}
                ...
                handleDevToolsResizeMouseDown={handleDevToolsResizeMouseDown}
              />
            </main>

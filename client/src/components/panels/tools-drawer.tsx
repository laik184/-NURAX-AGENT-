...
export function ToolsDrawer() {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 bottom-0 left-0 z-50 w-72 bg-[#0f1419] border-r border-gray-800 transition-all duration-300 ${toolsOpen ? "translate-x-0" : "-translate-x-full"}`}>
